...
function GameTooltip.SetBagItem(self, container, slot)
    ...
    GameTooltip.itemCount = count and ((count < 0) and 1 or count)
            ...
            if GuildBank.BottomTab == 1 and GuildBankFrame:IsVisible() then
                ...
                if button == "RightButton" and GuildBankFrame:IsVisible() then
                    ...
                    if GetContainerItemInfo(bag, slot) then
                        ...
                        count = (count < 0) and 1 or count -- fix for superwow
...
function BankSlot_OnReceiveDrag()
    ...
    if GuildBank:CursorHasBagItem() then
        ...
        GuildBank:Send("DepositItem:" .. GuildBank.cursorItem.tab .. ":" .. GuildBank.cursorItem.slot .. ":" .. frame.tab .. ":" .. frame.slot .. ":" .. ((count < 0) and 1 or count))
        ClearCursor();
        GuildBank:ResetAction()
        return
